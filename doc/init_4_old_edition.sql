/*
 ...
 Source Server Version : before 5.7.7
 Source Schema         : jw_project

 Target Server Type    : MySQL
 Target Server Version : before 5.7.7
 File Encoding         : 65001
...
CREATE TABLE `blog_article`  (
  ...
  `is_top` char(1) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '0' COMMENT '顶置（0表示不顶置，1表示顶置）',
  `article_cover` varchar(1024) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '文章封面',
  `article_title` varchar(300) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '文章标题',
  `article_summary` varchar(500) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '文章简介',
  `article_content` longtext CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL COMMENT '文章内容',
  `article_visible` char(1) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '1' COMMENT '可见（0代表仅自己可见，1表示所有人可见）',
  `view_counts` int(11) NULL DEFAULT 0 COMMENT '浏览数量',
  `comment_allowed` char(1) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '1' COMMENT '是否允许评论(0表示不能评论，1表示可以评论)',
  `article_check` char(1) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '0' COMMENT '文章审核状态（1表示通过，0表示未审核，f表示未通过）',
  `is_deleted` char(1) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '0' COMMENT '是否删除(0代表存在 1代表删除)',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(100) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '更新者',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`article_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 42 CHARACTER SET = utf8mb4 COLLATE =  utf8mb4_unicode_ci COMMENT = '博客文章表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE =  utf8mb4_unicode_ci COMMENT = '博客标签关系表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `blog_category`  (
  ...
  `category_name` varchar(100) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '类别名称',
  ...
  `is_deleted` char(1) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '0' COMMENT '是否删除(0代表存在 1代表删除)',
  `create_by` varchar(100) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '创建者',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(100) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '更新者',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
...
CREATE TABLE `blog_comment`  (
  ...
  `comment_type` varchar(50) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NOT NULL COMMENT '评论类型',
  ...
  `comment_content` longtext CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL COMMENT '评论内容',
  `comment_check` char(1) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '0' COMMENT '评论审核状态（1表示通过，0表示未通过）',
  `is_deleted` char(1) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '0' COMMENT '是否删除(0代表存在 1代表删除)',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(100) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '更新者',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`comment_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 155 CHARACTER SET = utf8mb4 COLLATE =  utf8mb4_unicode_ci COMMENT = '博客评论表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `blog_friend`  (
  ...
  `friend_title` varchar(64) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '标题',
  `friend_cover` varchar(256) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '封面',
  `friend_url` varchar(256) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '链接',
  `friend_introduction` varchar(1024) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '简介',
  `remark` varchar(500) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '备注',
  `status` char(1) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '1' COMMENT '状态(1正常 f停用, 0待定)',
  `is_deleted` char(1) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '0' COMMENT '是否删除(0代表存在 1代表删除)',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`friend_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE =  utf8mb4_unicode_ci COMMENT = '友链表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `blog_message`  (
  ...
  `message_nickname` varchar(255) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '昵称',
  `message_avatar` varchar(255) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '留言地址',
  `message_email` varchar(255) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '留言邮箱',
  `message_content` text CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL COMMENT '留言内容',
  `message_check` char(1) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '0' COMMENT '留言审核状态（1表示通过，0表示未审核）',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`message_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE =  utf8mb4_unicode_ci COMMENT = '弹幕留言表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `blog_moments`  (
  ...
  `moments_content` varchar(1024) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '内容',
  `is_public` char(1) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '1' COMMENT '是否公开(0代表私密 1代表公开)',
  `is_deleted` char(1) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '0' COMMENT '是否删除(0代表存在 1代表删除)',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`moments_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE =  utf8mb4_unicode_ci COMMENT = '朋友圈表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `blog_tag`  (
  ...
  `tag_name` varchar(100) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '标签名称',
  `remark` varchar(500) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '备注',
  `status` char(1) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '1' COMMENT '状态(1正常 0停用)',
  `is_deleted` char(1) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '0' COMMENT '是否删除(0代表存在 1代表删除)',
  `create_by` varchar(100) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '创建者',
...
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8mb4 COLLATE =  utf8mb4_unicode_ci COMMENT = '博客标签表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `blog_web`  (
  ...
  `web_title` varchar(512) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NOT NULL COMMENT '网站标题',
  `web_notices` varchar(512) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '网站公告',
  `web_footer` varchar(256) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NOT NULL COMMENT '网站页脚',
  `background_image` varchar(256) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '背景',
  `web_avatar` varchar(256) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NOT NULL COMMENT '网站头像',
  ...
  `article_check` char(1) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '1' COMMENT '开启文章审核(1:不开启, 0:开启)',
  `comment_check` char(1) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '1' COMMENT '开启评论审核(1:不开启, 0:开启)',
  `message_check` char(1) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '1' COMMENT '开启留言审核(1:不开启, 0:开启)',
  `status` char(1) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '1' COMMENT '是否启用[0:否，1:是]',
  `update_by` varchar(100) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '更新者',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
...
CREATE TABLE `dl_face_database`  (
  ...
  `face_name` varchar(100) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '人脸名',
  `face_sex` varchar(5) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '人脸性别',
  `face_type` varchar(100) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '人脸类别',
  `image_name` varchar(200) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '图片名称',
  `image_address` varchar(1024) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '图片地址',
  `remark` varchar(500) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '备注',
  `status` char(1) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '1' COMMENT '状态(1正常 0停用)',
  `is_deleted` char(1) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '0' COMMENT '是否删除(0代表存在 1代表删除)',
  `create_by` varchar(100) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '创建者',
...
) ENGINE = InnoDB AUTO_INCREMENT = 35 CHARACTER SET = utf8mb4 COLLATE =  utf8mb4_unicode_ci COMMENT = '人脸库' ROW_FORMAT = Dynamic;
...
CREATE TABLE `dl_face_detect_file`  (
  ...
  `file_name` varchar(100) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '检测文件名',
  `file_address` varchar(1024) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '检测文件地址',
  `file_type` varchar(10) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '检测文件类别',
  `detect_status` int(11) NULL DEFAULT 0 COMMENT '检测状态(0:未检测, 1:检测中, 2:检测完成, -1:检测失败)',
  `save_result` char(1) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '1' COMMENT '是否保存检测结果(0:否, 1:是)',
  `result_file_address` varchar(1024) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '检测结果文件地址',
  `result_msg` varchar(4096) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '检测结果描述',
  `remark` varchar(500) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '备注',
  `is_deleted` char(1) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '0' COMMENT '是否删除(0代表存在 1代表删除)',
  `create_by` varchar(100) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '创建者',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  ...
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 40 CHARACTER SET = utf8mb4 COLLATE =  utf8mb4_unicode_ci COMMENT = '检测人脸文件表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_login_log`  (
  ...
  `username` varchar(100) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '登录账户',
  `login_ip` varchar(128) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '登录ip',
  `login_location` varchar(300) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '操作地址',
  `login_browser` varchar(50) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '登录浏览器',
  `login_os` varchar(50) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '操作系统',
  `status` int(11) NULL DEFAULT 0 COMMENT '登录状态（0正常 1异常）',
  `login_msg` varchar(2000) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '登录结果',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 443 CHARACTER SET = utf8mb4 COLLATE =  utf8mb4_unicode_ci COMMENT = '用户登录日志' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_menu`  (
  ...
  `menu_type` varchar(20) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '菜单类别(目录，菜单，按钮)',
  `icon` varchar(100) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '#' COMMENT '菜单图标',
  `path` varchar(300) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '路由地址',
  `component` varchar(300) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '组件路径',
  `perms` varchar(300) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '权限标识',
...
CREATE TABLE `sys_operation_log`  (
  ...
  `opt_module` varchar(100) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '操作模块名',
  `opt_type` varchar(10) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '操作类型',
  `opt_desc` varchar(200) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '操作描述',
  `request_url` varchar(300) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '请求url',
  `request_method` varchar(10) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '请求方式',
  `opt_method` varchar(100) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '方法名称',
  `request_param` longtext CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL COMMENT '请求参数',
  `response_result` longtext CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL COMMENT '响应参数',
  `status` int(11) NULL DEFAULT 0 COMMENT '操作状态（0正常 1异常）',
  `error_msg` longtext CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL COMMENT '错误信息',
  `opt_user` varchar(100) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '操作人',
  `opt_ip` varchar(128) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '操作ip',
  `opt_location` varchar(300) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '操作地址',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1045 CHARACTER SET = utf8mb4 COLLATE =  utf8mb4_unicode_ci COMMENT = '系统操作日志表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_role`  (
  ...
  `role_code` varchar(100) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NOT NULL COMMENT '角色标识',
  `role_name` varchar(100) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NOT NULL COMMENT '角色名',
  ...
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 18 CHARACTER SET = utf8mb4 COLLATE =  utf8mb4_unicode_ci COMMENT = '系统角色表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_user`  (
  ...
  `user_type` varchar(50) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '用户类型（模块名）',
  `email` varchar(50) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '用户邮箱',
  `phone` varchar(11) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '' COMMENT '手机号码',
  `sex` varchar(5) CHARACTER SET utf8mb4 COLLATE  utf8mb4_unicode_ci NULL DEFAULT '保密' COMMENT '用户性别',
  ...
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 35 CHARACTER SET = utf8mb4 COLLATE =  utf8mb4_unicode_ci COMMENT = '系统用户表' ROW_FORMAT = Dynamic;
